...
# -----------------------------------------------------------------------------------------
# Feature by https://github.com/officialallan10k/
meron = []
wala = []
...
banner = """
  ...
  ▀▄▀▄▀ █▀▀   ▄█ █▄▄ █▀█ █ ▀█ █ ▀█ ██▄ █▀▄ """
dashline = " ------------------------------------------"
author = " [+]   officialallan10k  -  mkdirlove   [+]"
...
#---------------------------------------------
parser = argparse.ArgumentParser(description="WP-Scanner ~ WordPress Website Scanner Tool")
parser.add_argument("-u", "--url", help="Website Url with https://")
...
org_url = args.url
roboturl = f'{args.url}/robots.txt'
feedurl = f'{args.url}/feed'
args.url = f'{args.url}/wp-json'
